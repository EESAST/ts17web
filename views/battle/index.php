...
<div>
    ...
    <div class="row" align="center">
        <h2 width="90%">每个队伍每天最多对战100次<br/>你们今天已经对战了<?=$myteam->battled_time?>次<br/></h2>
    ...
    <table border="1" width=95% align="center">
        ...
        <?php foreach ($results as $result) { ?>
            <tr>
                ...
                <?php if($result->team1===$myteam->teamname || $result->team2===$myteam->teamname||Yii::$app->user->identity->username == 'github_404' ||Yii::$app->user->identity->username == 'gaffey'||Yii::$app->user->identity->username == '13aeon'||Yii::$app->user->identity->username == 'SigmaGo'||Yii::$app->user->identity->username == 'lzhbrian'){?>
