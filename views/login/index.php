    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var error = "<?php if($model['errors'])echo $model['errors']['verifyCode'][0]; ?>";
            if (error) {
                var verifyCode = $("#form_verifyCode").children("input");
                $("#form_verifyCode").addClass("am-form-icon am-form-feedback am-form-error");
                verifyCode.attr({"placeholder":"请输入正确的验证码"});
            }
