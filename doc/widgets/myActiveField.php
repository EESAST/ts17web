 ...
 * @since 2.0
 */
class myActiveField extends Component
{
    public $placeholder;
    /**
     ...
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $inputOptions = ['class' => 'am-form-field'];
    /**
   ...
   /* public function begin()
    ...
    public function error($options = [])
    {
        ...
        //$this->parts['{error}'] = $this->model->getFirstError($this->attribute);
    ...
    {
        $options = array_merge($this->inputOptions, $options,['placeholder'=>$this->placeholder,]);
    ...
    public function textInput($options = [])
    {
        ...
        if($error)$this->parts['{input}'].="<span class='am-icon-times'></span>";
        return $this;
    }
